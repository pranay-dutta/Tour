  ...
  return (
    <div>
      <div className="flex flex-col items-center gap-8 mt-8">
        ...
        <h1 className="lg:text-3xl md:text-2xl sm:text-xl text-2xl md:text-center text-left font-semibold font-lora w-9/12">Exploring Horizons: A Journey Through the World - The Tour</h1>
